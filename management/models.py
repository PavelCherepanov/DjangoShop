...
class ColorManagement(models.Model):
    ...
    color_name_value = models.CharField(max_length=6, verbose_name='Тип', null=True)
    def __str__(self):
...
class Product(models.Model):
    ...
    product_description = models.CharField(max_length=400, verbose_name='Описание', blank=True)
    ...
    product_img_hover = models.ImageField(upload_to='product_img/', default='-')
    def __str__(self):
